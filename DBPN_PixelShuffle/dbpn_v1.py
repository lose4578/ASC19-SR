...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        # Reconstruction
        self.output_conv1 = ConvBlock(base_filter * 9, base_filter, 1, 1, 0, activation=None, norm=None)
        self.output_conv2 = ConvBlock(base_filter, 16*3, kernel, stride, padding, activation=None, norm=None)
