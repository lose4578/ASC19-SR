...
parser.add_argument('--input_dir', type=str, default='/home/teacher-chen/Data/PIRM_dataset/Test/4x_downsampled')
parser.add_argument('--output', default='Results/', help='Location to save checkpoint models')
parser.add_argument('--test_dataset', type=str, default='')
parser.add_argument('--model_type', type=str, default='DBPNLL')
parser.add_argument('--residual', type=bool, default=False)
parser.add_argument('--model', default='weights/DIV2K_train_HRcentos7DBPNLLtpami_residual_filter8_epoch_49.pth', help='sr pretrained base model')
