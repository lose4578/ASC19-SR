...
parser.add_argument('--input_dir', type=str, default='/home/teacher-chen/Data/PIRM_dataset/Test/')
parser.add_argument('--output', default='Results/', help='Location to save checkpoint models')
parser.add_argument('--test_dataset', type=str, default='4x_downsampled')
parser.add_argument('--model_type', type=str, default='DBPNLL')
parser.add_argument('--model', default='weights/centos7DBPNLLPIRM_VGGVGG_epoch_124.pth', help='sr pretrained base model')
...
# test_set = 'D:/ASC19/数据集/PIRM_dataset/Test/4x_downsampled'
