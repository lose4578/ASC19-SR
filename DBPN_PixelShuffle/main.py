...
parser.add_argument('--data_augmentation', type=bool, default=False)  # 数据扩充
...
parser.add_argument('--patch_size', type=int, default=140, help='Size of cropped HR image')  # 裁剪后的HR图像的大小
parser.add_argument('--pretrained_sr', default='DIV2K_train_HRcentos7DBPNLLtpami_residual_filter8_epoch_499.pth', help='sr pretrained base model')
