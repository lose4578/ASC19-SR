...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        self.feat1 = ConvBlock(num_channels, base_filter, 1, 1, 0, activation='prelu', norm=None)
        ...
        #
        self.feat2 = ConvBlock(base_filter, num_channels, 1, 1, 0, activation='prelu', norm=None)
